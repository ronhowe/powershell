@{
    Modules = @(
        ...
        @{ Name = 'Az' ; Version = '14.3.0' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
        ...
        # https://dbatools.io
        @{ Name = 'dbatools' ; Version = '2.7.2' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
        ...
        @{ Name = 'InvokeBuild' ; Version = '5.14.16' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
