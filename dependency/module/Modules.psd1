@{
    Modules = @(
        ...
        @{ Name = 'Az' ; Version = '14.5.0' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
        ...
        @{ Name = 'InvokeBuild' ; Version = '5.14.20' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
