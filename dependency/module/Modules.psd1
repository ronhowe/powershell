@{
    Modules = @(
        ...
        @{ Name = 'Az' ; Version = '14.6.0' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
        ...
        # https://dbatools.io
        @{ Name = 'dbatools' ; Version = '2.7.7' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
        ...
        @{ Name = 'InvokeBuild' ; Version = '5.14.21' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
