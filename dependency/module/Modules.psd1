@{
    Modules = @(
        ...
        @{ Name = 'Az' ; Version = '14.4.0' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
        ...
        # https://dbatools.io
        @{ Name = 'dbatools' ; Version = '2.7.6' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
        ...
        @{ Name = 'InvokeBuild' ; Version = '5.14.19' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
