@{
    Modules = @(
        ...
        @{ Name = 'Az.Accounts' ; Version = '4.1.0' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
        ...
        @{ Name = 'Az.Resources' ; Version = '7.10.0' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
        @{ Name = 'Az.Storage' ; Version = '8.3.0' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
        @{ Name = 'Az.Tools.Predictor' ; Version = '1.1.3' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core') },
        @{ Name = 'Az.Websites' ; Version = '3.4.0' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
