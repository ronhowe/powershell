@{
    Modules = @(
        # @{ Name = 'Az.Tools.Predictor' ; Version = '1.1.3' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') }, ## NOTE: This module ight be useful someday.
        # https://github.com/Azure/azure-powershell
        @{ Name = 'Az' ; Version = '13.4.0' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
        # https://github.com/torgro/cliMenu
        # @{ Name = 'CliMenu' ; Version = '1.0.52.0' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') }, ## NOTE: This module is failing to download.
        ...
        # https://dbatools.io
        @{ Name = 'dbatools' ; Version = '2.1.30' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
        ...
        # @{ Name = 'ImportExcel' ; Version = '7.8.10' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') }, ## NOTE: This module might be useful someday.
        # https://github.com/nightroman/Invoke-Build
        @{ Name = 'InvokeBuild' ; Version = '5.12.2' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
        ...
        @{ Name = 'ModuleBuilder' ; Version = '3.1.7' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
        # https://oneget.org/
        ...
        # @{ Name = 'PowerConfig' ; Version = '0.1.6' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') }, ## NOTE: This module has not been updated with latest .NET and no longer works well.
        ...
        # @{ Name = 'PSWindowsUpdate' ; Version = '2.2.1.5' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') }, ## NOTE: This module is interesting, but doesn't work well remotely.
