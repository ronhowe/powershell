@{
    Modules = @(
        ...
        # https://dbatools.io
        @{ Name = 'dbatools' ; Version = '2.7.3' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
        ...
        @{ Name = 'InvokeBuild' ; Version = '5.14.18' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
