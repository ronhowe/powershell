@{
    Modules = @(
        @{ Name = 'Az' ; Version = '11.0.0' ; Repository = 'PSGallery' ; Scope = 'CurrentUser' },
        ...
        @{ Name = 'ModuleBuilder' ; Version = '3.0.2' ; Repository = 'PSGallery' ; Scope = 'CurrentUser' },
        ...
        @{ Name = 'PSWindowsUpdate' ; Version = '2.2.1.2' ; Repository = 'PSGallery' ; Scope = 'CurrentUser' },
