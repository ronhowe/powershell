@{
    Modules = @(
        ...
        @{ Name = 'Az.ConnectedMachine' ; Version = '0.8.0' ; Repository = 'PSGallery' ; Scope = 'CurrentUser' },
        ...
        @{ Name = 'dbatools' ; Version = '2.1.16' ; Repository = 'PSGallery' ; Scope = 'CurrentUser' },
        @{ Name = 'ImportExcel' ; Version = '7.8.9' ; Repository = 'PSGallery' ; Scope = 'CurrentUser' },
        @{ Name = 'InvokeBuild' ; Version = '5.11.1' ; Repository = 'PSGallery' ; Scope = 'CurrentUser' },
        ...
        @{ Name = 'Pester' ; Version = '5.6.0' ; Repository = 'PSGallery' ; Scope = 'CurrentUser' },
