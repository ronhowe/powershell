@{
    Modules = @(
        @{ Name = 'Az' ; Version = '11.5.0' ; Repository = 'PSGallery' ; Scope = 'CurrentUser' },
        @{ Name = 'Az.ConnectedMachine' ; Version = '0.7.1' ; Repository = 'PSGallery' ; Scope = 'CurrentUser' },
        ...
        @{ Name = 'dbatools' ; Version = '2.1.14' ; Repository = 'PSGallery' ; Scope = 'CurrentUser' },
