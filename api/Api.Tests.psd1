@{
    Endpoints = @(
        ...
        # @{ Enabled = $true ; Endpoint = @{ Name = "Docker" ; Uri = "http://localhost:82"; CustomHeader = "default" } }
        @{ Enabled = $true ; Endpoint = @{ Name = "Function App" ; Uri = "http://localhost:84/api"; CustomHeader = "default" } }
    )
}
